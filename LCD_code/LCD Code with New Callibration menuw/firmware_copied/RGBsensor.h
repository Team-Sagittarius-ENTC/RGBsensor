...
class RGBsensor{
  private:
    ...
    void update_coeff(byte ref_, byte itter = 9); // this function is to update the cofficiant matrix 
    
    void procRegression(byte itter = 9); // this is the function to process the regression
  ...
  public:
    ...
    void calibrate(Display lcd, Keypad keypad, bool grayScale = true); // this is the calibration function
