...
public:
  ...
  void printMsg(String message, byte alignment = 0, bool line = 0); // function to printout messages
  ...
  int inputColor(byte positionx, byte positiony, Keypad keypad); // this function is used to input color when needed
